...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CustomersRelationshipManager>().As<ICustomersRelationshipService>().SingleInstance();
            builder.RegisterType<EfCustomersRelationshipDal>().As<ICustomersRelationshipDal>().SingleInstance();
